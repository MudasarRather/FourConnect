<template>
  <div class="expenses-page">
    ...
    <EditDraftModal
       ...
       @submitted="handleExpenseUpdated"
    />
...
const fetchData = async () => {
  ...
  try {
    const h = getHeaders()
    const { data } = await axios.get(`${API}/expenses/?expense_status=draft&limit=200`, { headers: h })
    expenses.value = data
  } catch (e) {
...
[data-theme="light"] .banner-title { color: #92400e; }
