...
const chartComp = computed(() => ({ line: Line, bar: Bar, doughnut: Doughnut }[props.type] || Line))
...
const options = computed(() => {
  ...
  return {
    ...base,
    scales: {
      y: { stacked: props.stacked, grid: { color: grid, drawBorder: false }, ticks: { color: tick, font: { size: 10 } } },
...
<style scoped>
.rmb-chart-wrap { position: relative; height: 100%; width: 100%; }
</style>
